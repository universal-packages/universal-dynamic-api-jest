...
describe('dynamic-api-jest', (): void => {
  describe('toHaveBeenHookedAfter (errors)', (): void => {
    ...
    it('throws if a dynamic is passed instead of a hook', async (): Promise<void> => {
      ...
      try {
        expect(GoodDynamic).toHaveBeenHookedAfter(GoodDynamic)
      } catch (e) {
        error = e
      }
    ...
    it('throws if the subject is not a hook', async (): Promise<void> => {
      ...
      try {
        expect({}).toHaveBeenHookedAfter(GoodDynamic)
      } catch (e) {
        error = e
      }
    ...
    it('throws if dynamic was not loaded', async (): Promise<void> => {
      ...
      try {
        expect(GoodBeforeHookDynamic).toHaveBeenHookedAfter({ __name: 'dynamic' })
      } catch (e) {
        error = e
      }
    ...
    it('throws if a hook is passed instead of a dynamic', async (): Promise<void> => {
      ...
      try {
        expect(GoodBeforeHookDynamic).toHaveBeenHookedAfter(GoodBeforeHookDynamic)
      } catch (e) {
        error = e
      }
    ...
    it('throws if the dynamic is not a dynamic', async (): Promise<void> => {
      ...
      try {
        expect(GoodBeforeHookDynamic).toHaveBeenHookedAfter({})
      } catch (e) {
        error = e
      }
